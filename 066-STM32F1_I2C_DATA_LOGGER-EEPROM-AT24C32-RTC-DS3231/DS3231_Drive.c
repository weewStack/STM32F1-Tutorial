...
void DS3231_Time_Date(char * time_table,char* out_str,char time_date)
{
	if(time_date)
	{
		int2date(DS3231_reverter(time_table[6]),out_str);
		int2date(DS3231_reverter(time_table[5]),out_str);
		int2date(DS3231_reverter(time_table[4]),out_str);
	}
	else
	{
		int2time(DS3231_reverter(time_table[2]),out_str);
		int2time(DS3231_reverter(time_table[1]),out_str);
		int2time(DS3231_reverter(time_table[0]),out_str);
	}
